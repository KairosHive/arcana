...
That installs the package, its dependencies and seven commands: `arcana`,
`arcana-build-latent`, `arcana-extend`, `arcana-finish`, `arcana-marks`,
`arcana-relocate` and `arcana-migrate`.
